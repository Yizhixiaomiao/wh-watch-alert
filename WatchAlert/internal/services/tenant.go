...
type InterTenantService interface {
	...
	Search(req interface{}) (data interface{}, err interface{})
...
func (ts tenantService) Search(req interface{}) (data interface{}, err interface{}) {
	r := req.(*types.RequestTenantSearch)
	data, _, err = ts.ctx.DB.Tenant().Search(r.Keyword, r.Page, r.Size)
	if err != nil {
		return nil, err
	}
	return data, err
