...
type (
	...
	InterEntryRepo interface {
		...
		Ticket() InterTicketRepo
		TicketReview() InterTicketReviewRepo
		WorkHours() InterWorkHoursRepo
		Knowledge() InterKnowledgeRepo
		AssignmentRule() InterAssignmentRuleRepo
		AlertTicketRule() InterAlertTicketRuleRepo
	}
)
...
func (e *entryRepo) Ticket() InterTicketRepo             { return newTicketInterface(e.db, e.g) }
func (e *entryRepo) TicketReview() InterTicketReviewRepo { return newTicketReviewInterface(e.db, e.g) }
func (e *entryRepo) WorkHours() InterWorkHoursRepo       { return newWorkHoursInterface(e.db, e.g) }
func (e *entryRepo) Knowledge() InterKnowledgeRepo       { return newKnowledgeInterface(e.db, e.g) }
func (e *entryRepo) AssignmentRule() InterAssignmentRuleRepo {
	return newAssignmentRuleInterface(e.db, e.g)
}
func (e *entryRepo) AlertTicketRule() InterAlertTicketRuleRepo {
	return newAlertTicketRuleInterface(e.db, e.g)
}
