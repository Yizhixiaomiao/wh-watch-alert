...
func (alertEventController alertEventController) API(gin *gin.RouterGroup) {
	...
	)
	{
		...
		a.POST("archiveAlertEvent", alertEventController.ArchiveAlertEvent)
...
func (alertEventController alertEventController) ArchiveAlertEvent(ctx *gin.Context) {
	r := new(types.RequestArchiveAlertEvent)
	BindJson(ctx, r)
	...
	Service(ctx, func() (interface{}, interface{}) {
		return services.EventService.ArchiveAlertEvent(r)
	})
}
