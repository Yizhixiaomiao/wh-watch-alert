...
async function getFolderList(params?: any, options = {}) {
    try {
        const res = await http('get', '/api/w8t/dashboard/listFolder', params, options);
        return res;
    } catch (error) {
...
async function getGrafanaDashboardList(params?: any, options = {}) {
    try {
        const res = await http('get', '/api/w8t/dashboard/listGrafanaDashboards', params, options);
        return res;
    } catch (error) {
        HandleApiError(error)
        return error
