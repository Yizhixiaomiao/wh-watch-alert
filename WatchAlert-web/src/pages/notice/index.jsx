...
export const NoticeObjects = () => {
    ...
    const handleList = async (skipCache = false) => {
        ...
        try {
            const res = await getNoticeList({}, { skipCache })
            setList(res.data);
        } catch (error) {
            message.error(error);
        }
    ...
    const handleDelete = async (record) => {
        try {
            ...
            clearCacheByUrl('/api/w8t/notice')
            clearCacheByUrl('/api/w8t/notice/list')
    ...
    const onSearch = async (value) => {
        try {
            ...
            const res = await getNoticeList(params, { skipCache: true })
            setList(res.data)
        } catch (error) {
            console.error(error)
        }
